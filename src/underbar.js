(function() {
  ...
  _.last = function(array, n) {
    // console.log(Math.max(array.length - 1), 'test')
  ...
  _.filter = function(collection, test) {
    ...
    _.each(collection, function(item) {
      return test(item) === true ? results.push(item) : undefined;
    });
    return results;
  };
  ...
  _.reject = function(collection, test) {
    ...
    var results = [];
    _.each(collection, function(item) {
      return test(item) === false ? results.push(item) : undefined;
    });
    return results;
  };
  ...
  _.shuffle = function(array) {
    var arrayDuplicate = array.slice();
    return arrayDuplicate.sort(function(a, b) {
